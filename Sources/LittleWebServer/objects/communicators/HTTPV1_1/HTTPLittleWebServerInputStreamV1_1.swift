//
//  HTTPLittleWebServerInputStreamV1_1.swift
//  LittleWebServer
//
...
internal class HTTPLittleWebServerInputStreamV1_1: LittleWebServerInputStream {
    ...
    public func readChunk() throws {
        ...
        let hexSize = try HTTPParserV1_1.readHTTPLine(from: self.client)
